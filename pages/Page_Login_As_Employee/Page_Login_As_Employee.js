...
const Page_Login_As_Employee  = ({navigation}) => {
	useEffect(() => {
	}, []);
	return (
	...
	<ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{height: Dimensions.get("window").height}}>
		<View style = {noneModeStyles._page4}    >
			...
			<View style = {noneModeStyles._undraw_Mobile_login_re_9ntv_1}    >
				...
				<View style = {noneModeStyles.style19}    >
					<View style = {noneModeStyles.style20}   >
						<Svg style={{height: 21, width: 34}} viewBox = "0 0 34 21">
							<Path fill = {"#F0F0F0"}     d = "M6.03413 20.3324C5.89285 20.3661 5.74911 20.3977 5.60497 20.4264L0 15.4656C0.10954 15.4274 0.237558 15.382 0.383965 15.3316C2.7888 14.48 9.95135 11.9094 17.0793 8.98153C24.7384 5.83415 32.3607 2.27793 34 0C33.6483 0.52928 22.8162 16.5797 6.03413 20.3324Z"/>
						</Svg>
					</View>
				</View>
				...
				<View style = {noneModeStyles.style49}    >
					<View style = {noneModeStyles.style50}   >
						<Svg style={{height: 10, width: 4}} viewBox = "0 0 4 10">
							<Path fill = {"#2F2E41"}     d = "M0.0160489 9.82694C0.970248 9.80045 2.15781 9.76733 3.07269 9.09901C3.34512 8.89184 3.56895 8.62762 3.72851 8.32484C3.88806 8.02205 3.97948 7.68805 3.99635 7.34621C4.01289 7.10328 3.97303 6.8598 3.87988 6.63483C3.78673 6.40985 3.64281 6.20947 3.45938 6.04933C2.98154 5.64555 2.28378 5.55085 1.53182 5.77183L2.31091 0.0783508L1.73899 0L0.823094 6.69341L1.30069 6.47425C1.85439 6.22029 2.61444 6.09106 3.08675 6.49019C3.20273 6.59453 3.29309 6.72422 3.35079 6.86917C3.4085 7.01412 3.432 7.17041 3.41946 7.32592C3.40546 7.58033 3.33683 7.82875 3.21823 8.05427C3.09963 8.27978 2.93385 8.47711 2.73216 8.63281C2.0202 9.15286 1.07361 9.21994 0 9.24996L0.0160489 9.82694Z"/>
						</Svg>
					</View>
				</View>
				...
				<View style = {noneModeStyles.style53}    >
					<View style = {noneModeStyles.style54}   >
						<Svg style={{height: 1, width: 3}} viewBox = "0 0 3 1">
							<Path fill = {"#2F2E41"}     d = "M3 0H0V0.557019H3V0Z"/>
						</Svg>
					</View>
				</View>
				...
				<View style = {noneModeStyles.style59}    >
					<View style = {noneModeStyles.style60}   >
						<Svg style={{height: 35, width: 34}} viewBox = "0 0 34 35">
							<Path fill = {"#2F2E41"}     d = "M18.0337 33.898L8.46922 30.1856C6.90523 29.5786 5.33249 28.99 3.77678 28.362C3.11039 28.1298 2.49653 27.768 1.97059 27.2975C1.5127 26.8128 1.20062 26.2088 1.07012 25.5549C0.738389 24.1528 0.798365 22.6198 0.822024 21.1889C0.840379 19.6236 0.969198 18.0615 1.20751 16.5144C1.62519 13.6069 2.60608 10.8089 4.0952 8.2771C6.77748 3.87612 11.3989 0.564974 16.7147 0.829233C19.1757 0.95157 21.6509 1.83467 23.4794 3.51729C23.6701 3.74523 23.8841 3.95264 24.1179 4.13615C24.2805 4.1971 24.4573 4.20897 24.6265 4.17029C24.8496 4.15593 25.073 4.14498 25.2965 4.13742C26.072 4.10471 26.8488 4.1373 27.6189 4.23484C29.0222 4.38644 30.3522 4.9387 31.4502 5.82569C32.3639 6.61174 33.1074 7.72141 33.1839 8.95458C33.2209 9.52068 33.1273 10.0877 32.9104 10.6119C32.6934 11.1361 32.359 11.6034 31.9328 11.9779C30.7917 12.9396 29.1637 12.6016 27.7949 12.5291L22.7806 12.2634L20.24 12.1288C19.7168 12.1011 19.7184 12.9146 20.24 12.9422L26.9926 13.3C28.0778 13.3575 29.1961 13.4984 30.2822 13.4333C31.1166 13.3955 31.9134 13.075 32.5416 12.5243C33.1153 11.9973 33.5426 11.3307 33.782 10.5893C34.0213 9.84798 34.0645 9.05728 33.9072 8.29429C33.5591 6.63018 32.3206 5.25358 30.8687 4.43463C28.8931 3.32031 26.5337 3.21354 24.3232 3.37828L24.6108 3.4974C22.1103 0.813636 18.2801 -0.319489 14.6844 0.077052C10.8879 0.495734 7.51117 2.61377 5.08504 5.50997C2.38006 8.73906 0.906011 12.7655 0.332955 16.9058C0.0347391 19.1412 -0.0634404 21.3988 0.0395842 23.6516C0.0353421 24.6452 0.205318 25.6318 0.541802 26.5667C0.925718 27.4765 1.61986 28.2207 2.5008 28.6669C3.51077 29.1545 4.54909 29.581 5.61016 29.9442L9.13392 31.3119L16.0556 33.9985L17.8175 34.6824C18.3058 34.8719 18.5173 34.0857 18.0337 33.898Z"/>
						</Svg>
					</View>
				</View>
				...
				<View style = {noneModeStyles.style63}    >
					<View style = {noneModeStyles.style64}   >
						<Svg style={{height: 16, width: 16}} viewBox = "0 0 16 16">
							<Path fill = {"#F0F0F0"}     d = "M16 6.93396L6.93396 0L-1.80069e-06 9.06603L9.06604 16L16 6.93396Z"/>
						</Svg>
					</View>
				</View>
				<View style = {noneModeStyles.style65}    >
					<View style = {noneModeStyles.style66}   >
						<Svg style={{height: 22, width: 28}} viewBox = "0 0 28 22">
							<Path fill = {"#F0F0F0"}     d = "M15.3496 15.3497C16.7804 15.3485 18.1916 15.6825 19.4701 16.3247C20.7486 16.967 21.859 17.8997 22.7123 19.0482L28 12.1345L12.1344 0L0 15.8656L6.83801 21.0956C7.52231 19.3984 8.6983 17.9446 10.215 16.9208C11.7316 15.8969 13.5197 15.3498 15.3496 15.3497Z"/>
						</Svg>
					</View>
				</View>
			...
			<Text style = {noneModeStyles._Login_as_Admin}   >
				Login as Admin
			</Text>
...
export default Page_Login_As_Employee
